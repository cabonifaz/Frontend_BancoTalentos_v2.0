  ...
  return (
    <div className="relative h-full flex flex-col p-6">
      ...
      <header className="mb-5">
        <h2 className="text-lg font-semibold text-gray-800">Gestores por cliente</h2>
              ...
              <div key={prioridad} className="flex-1 flex flex-col sm:flex-row sm:items-center gap-4">
                  ...
                  {isAssigningHere || isChangingHere ? (
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="min-w-0">
                        ...
                        <p className="truncate text-xs text-gray-400">@{gestor.usuario}</p>
                      </div>
                    ...
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-gray-300 py-4 text-sm text-gray-500 hover:border-[#009688] hover:text-[#00796B] transition-colors"
                    >
                ...
                {idx === 0 && (
                  <button
                    ...
                    className="mx-auto flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full border border-gray-200 text-gray-500 hover:bg-gray-100 transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent"
                  >
      ...
      {toRemove && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl border border-gray-200 w-full max-w-sm p-6 text-center flex flex-col items-center gap-3">
            ...
            <h3 className="text-base font-semibold text-gray-800">Quitar gestor</h3>
            <p className="text-sm text-gray-500">
              ¿Quitar a{" "}
