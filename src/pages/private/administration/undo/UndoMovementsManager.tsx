...
import {
  getEmployeeDetailFMI,
  listEmployeesFMI,
} from "../../../../core/services/apiService";
import { useUndoMovement } from "../../../../core/hooks/useUndoMovement";
import {
  EmployeeListItem,
  ...
  return (
    <div className="relative h-full flex flex-col p-6">
      ...
      <header className="mb-5">
        <h2 className="text-lg font-semibold text-gray-800">Deshacer movimientos</h2>
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-[minmax(280px,360px)_1fr] gap-4">
        {/* ── Lista de empleados ───────────────────────────────── */}
        <div className="flex flex-col min-h-0 border border-gray-100 rounded-lg">
        ...
        <div className="flex flex-col min-h-0 border border-gray-100 rounded-lg overflow-auto">
          {!selected ? (
      ...
      {pending && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl border border-gray-200 w-full max-w-md p-6">
            ...
            <p className="mb-6 text-sm text-gray-600">{pending.message}</p>
...
const EmptyRow = ({ cols }: { cols: number }) => (
  <tr>
    <td colSpan={cols} className="px-3 py-6 text-center text-gray-400">
      Sin registros.
    </td>
  </tr>
);
