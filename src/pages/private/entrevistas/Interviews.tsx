...
const BADGE_CLASSES: Record<number, string> = {
  1: "bg-green-100 text-green-700 dark:bg-green-500/15 dark:text-green-300", // Registrado
  2: "bg-blue-100 text-blue-700 dark:bg-blue-500/15 dark:text-blue-300", // En Proceso
  3: "bg-gray-100 text-gray-600 dark:bg-slate-700 dark:text-slate-300", // Finalizado
  4: "bg-red-100 text-red-600 dark:bg-red-500/15 dark:text-red-400", // Cancelado — mismo rojo que Perdido/Cancelado en RQ
};
  ...
  return (
    <Dashboard>
      ...
      <div className="flex h-full flex-col overflow-x-hidden gap-4">
        ...
        {/* Filters panel */}
        <div className="shrink-0 rounded-lg border border-gray-100 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800">
            ...
            <div className="flex flex-wrap items-center gap-3 border-t border-gray-100 pt-4 dark:border-slate-700">
              ...
              {hasActiveFilters && (
                <button
                  ...
                  className="ml-auto flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm text-gray-500 transition-colors hover:bg-gray-50 hover:text-gray-700 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-slate-200"
                >
