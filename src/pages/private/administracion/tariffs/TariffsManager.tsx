    ...
    <div className="relative h-full flex flex-col p-6">
      ...
      <div className="flex-1 min-h-0 overflow-auto border border-gray-100 rounded-lg dark:border-slate-700">
        <table className="w-full text-sm">
          ...
          <tbody>
            {tariffs.map((t) => (
              <tr key={t.idTarifario} className="border-t border-gray-100 hover:bg-gray-50 text-gray-600 dark:border-slate-700 dark:hover:bg-slate-700 dark:text-slate-300">
