            ...
            <div className="mt-5">
              ...
              <div className="mt-1 flex items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 transition-colors disabled:opacity-50 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700"
                >
                  <UploadCloud size={16} />
                ...
                {firmaPath ? (
                  ...
                  <span className="text-sm text-gray-400 dark:text-slate-500">Tiene una firma cargada</span>
                ) : (
                  <span className="text-sm text-gray-300 dark:text-slate-600">Sin firma</span>
                )}
                <input
                  ref={fileInputRef}
                  type="file"
