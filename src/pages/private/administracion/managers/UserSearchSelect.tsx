    ...
    <div className="rounded-lg border border-gray-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
      <div className="relative border-b border-gray-100 dark:border-slate-700">
        ...
        <button
          type="button"
          onClick={onCancel}
          className="absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded-full text-gray-400 hover:bg-gray-100 dark:text-slate-500 dark:hover:bg-slate-700"
          aria-label="Cancelar"
        >
          <X size={15} />
        </button>
      ...
      <div className="max-h-56 overflow-auto">
        {loading ? (
          <div className="flex items-center justify-center gap-2 py-6 text-sm text-gray-400 dark:text-slate-500">
