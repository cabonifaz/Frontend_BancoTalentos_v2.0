...
export const TalentCard = ({ talent, selectTalent }: Props) => {
  return (
    <div
      ...
      className="flex items-center px-3 py-2 hover:bg-[#f4f4f5] rounded-lg cursor-pointer relative dark:hover:bg-slate-700"
    >
      <div className="w-full min-w-0 pe-6">
        ...
        <p className="text-xs leading-tight text-[#71717A] truncate dark:text-slate-400">
          {talent.puesto}
        </p>
        <div className="flex items-center gap-2 mt-0.5 min-w-0">
          ...
          <p className="text-xs leading-tight text-[#71717A] flex items-center min-w-0 dark:text-slate-400">
            <MapPin className="h-3.5 w-3.5 shrink-0" />
            <span className="truncate">{`${talent.pais}, ${talent.ciudad}`}</span>
          </p>
        </div>
        <div className="text-xs leading-tight text-[#71717A] flex flex-wrap gap-x-3 dark:text-slate-400">
          <p>
            {`RxH ${
