  ...
  return (
    <div className="flex items-center justify-between gap-2 rounded-md my-1 px-2 sm:px-6 py-4 bg-[#f4f4f5] w-full dark:bg-slate-700">
      <div className="flex gap-3 sm:gap-6 items-center min-w-0">
        <Briefcase className="w-8 h-8 shrink-0 text-[#71717A] dark:text-slate-400" />
        <div className="flex flex-col gap-1 min-w-0">
          <h2 className="text-[#27272A] text-base dark:text-slate-100">
            {data.nombreEmpresa}
          </h2>
      ...
      <div className="shrink-0">
        <button
          type="button"
          title={`Editar experiencia en ${data.nombreEmpresa}`}
          onClick={onEdit}
