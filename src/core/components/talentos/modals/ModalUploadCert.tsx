...
export const ModalUploadCert = ({ idTalento, onUpdate }: Props) => {
    ...
    return (
        <Modal id="modalUploadCert" title="Sube un archivo del talento" confirmationLabel="Subir" onConfirm={handleOnConfirm} busy={loading}>
            ...
            <div className="pt-2">
                <div className="relative h-32 rounded-lg border-2 border-dashed border-gray-200 flex justify-center items-center transition-colors hover:border-[#0b85c3] hover:bg-[#f5fbff] dark:border-slate-700 dark:hover:bg-sky-500/10">
