...
import { addOrUpdateTalentEducation, deleteTalenteEducation } from "@/core/services/talents.service";
import {
  handleError,
  handleResponse,
...
import { EducationsSection } from "@/core/components";
    ...
    <FormProvider {...methods}>
      ...
      >
        ...
        <div className="relative">
          <h3 className="text-[#71717A] text-sm mt-6 mb-4 dark:text-slate-400">
            {isEditing
          ...
          {isEditing && (
            ...
            >
              <Trash2 className="w-6 h-6 mx-auto text-red-500" />
            </button>
          )}
