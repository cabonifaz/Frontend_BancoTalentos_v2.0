    ...
    >
      ...
      <div className="mt-5 flex flex-col h-min-[700px]">
        ...
        {(existingFile || generatedPDF) && (
          <div className="flex flex-col items-center gap-2 border-t border-gray-100 pt-4 dark:border-slate-700">
            <p className="text-xs text-gray-500 text-center max-w-md dark:text-slate-400">
