    ...
    return (
        <div className="flex items-center justify-around md:justify-start p-2 hover:bg-[#f4f4f5] rounded-xl cursor-pointer animate-pulse">
            ...
            <div className="w-3/4 md:w-full space-y-2">
                ...
                <div className="h-4 bg-gray-300 rounded w-64"></div> {/* Ajusta el ancho según el contenido real */}

                {/* Puesto (skeleton) */}
                <div className="h-4 bg-gray-300 rounded w-48"></div> {/* Ajusta el ancho según el contenido real */}
                ...
                <div className="flex items-center gap-2 my-1 lg:h-5">
                    ...
                    <div className="h-4 bg-gray-300 rounded w-32"></div> {/* Ajusta el ancho según el contenido real */}
                </div>
