  ...
  return (
    ...
    >
      <div className="mx-2 lg:ms-4 lg:me-8 w-1/4 md:w-fit">
        <img
          src={Utils.getImageSrc(talent.imagen)}
          alt="Foto Perfil Talento"
          className="w-20 h-20 md:w-24 md:h-24 xl:w-28 xl:h-28 rounded-full border"
        />
      </div>
      <div className="w-3/4 md:w-fit">
        ...
        <div className="text-sm text-[#71717A]">
          <div className="flex flex-row md:flex-col xl:flex-row gap-2 md:gap-0 xl:gap-2 flex-wrap">
            <p>
              {`RxH ${Utils.formatCoinByNum1(talent.idMonedaRxh).string3} `}
