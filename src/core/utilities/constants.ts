export const BASE_URL = "https://autfmibackendpreprod-hadmdsa5hjaghub8.canadacentral-01.azurewebsites.net";
export const BASE_URL_FMI = "https://bancotalentobackendpreprod-awdecbbsgrh4d8bn.canadacentral-01.azurewebsites.net";
